...
function Cat(options) {
  ...
  Animal.call(this, options); // setting up inheritance from Animal
}

// connect the prototypes here

Cat.prototype = Object.create(Animal.prototype); // Connecting Cat Prototypes to Animal Prototypes
